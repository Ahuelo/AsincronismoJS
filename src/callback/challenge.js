//unión a una API
//1. Instalar mediante git bash en el proyecto "npm i xmlhttprequest"
//2. Invocamos al archivo JS
const XMLHttpRequest = require ('xmlhttprequest').XMLHttpRequest;
//3. Hacemos la creación de la API
const API = 'https://api.escuelajs.co/api/v1';

//4. Creamos una function para verificar la conexión
